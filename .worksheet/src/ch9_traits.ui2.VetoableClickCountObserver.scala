...
package ch9_traits.ui2

import ch9_traits.ui2._
import ch9_traits.observer._

object VetoableClickCountObserver{;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(381); 
	...
	val bco1 = new ClickCountObserver;System.out.println("""bco1  : ch9_traits.ui2.VetoableClickCountObserver.ClickCountObserver = """ + $show(bco1 ));$skip(35); 
	val bco2 = new ClickCountObserver;System.out.println("""bco2  : ch9_traits.ui2.VetoableClickCountObserver.ClickCountObserver = """ + $show(bco2 ));$skip(27); 
